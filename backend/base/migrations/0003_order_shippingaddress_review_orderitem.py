    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxPrise', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipingPrise', models.DecimalField(blank=True, decimal_places=2, max_digits=7, null=True)),
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reting', models.IntegerField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('oreder', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.order')),
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.product')),
            ],
        ),
    ]
